/**
 * Inline SVG, 16px, currentColor, 1.5 stroke.
 *
 * Inline markup rather than an icon font or a sprite sheet: the bar lives in a shadow
 * root, so an external sprite would need its own request and a font would need a
 * @font-face the host page's CSP may not allow.
 *
...
export function icon(name, extra = '') {
  return `<svg class="ndb-icon ${extra}" viewBox="0 0 24 24" fill="none" stroke="currentColor"
